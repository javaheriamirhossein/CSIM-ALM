function [s,u,rel_err,time_iter] = csim_alm_alpha( D,y,Opt )
%-----------------------------------------------------------------------------------------------------------
% CSIM-ALM algorithm with alpha continuation to solve: 
...
%
% USAGE EXAMPLES
%   [s] = csim_alm_alpha(D,y);
%   [s,u,rel_err,time_iter] = csim_alm_alpha(D,y,Opt);
%
%-------------------------------------------------------------------------------------------------------------
...
while iter<Niter
    ...
    % ----- backtracking to find the appropriate value of lambda ---------
    count = 0; 
