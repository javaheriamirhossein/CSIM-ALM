function [s,rel_err,time_iter]=SL0(A, x, Opt)
%
...
if ~isfield(Opt,'sigma_min')
    Opt.sigma_min = 1e-6;
end

if ~isfield(Opt,'sigma_decrease_factor')
...
if isfield(Opt,'true_s')
    ShowProgress = true;
end


sigma_decrease_factor = Opt.sigma_decrease_factor;
A_pinv = Opt.D_pinv;
...
if Opt.errorshow
    ...
    scale_x = Opt.max_x ;
    norm_x0 = norm(x0);
    rel_err = NaN(1,Opt.Niteration);
    time_iter = NaN(1,Opt.Niteration);
end
% ---------------------------------------
